...
namespace BiliBili_WinUI_Desktop.Components.Controls
{
    public sealed partial class RenderTextBlock : UserControl
    {
        ...
        public static new readonly DependencyProperty FontSizeProperty =
            DependencyProperty.Register("FontSize", typeof(double), typeof(RenderTextBlock), new PropertyMetadata(14));
        ...
        public static readonly DependencyProperty LineHeightProperty =
            DependencyProperty.Register("LineHeight", typeof(int), typeof(RenderTextBlock), new PropertyMetadata(Convert.ToInt32(Math.Floor(14*1.3))));
        ...
        private void richBlock_LinkClicked(object sender, CommunityToolkit.WinUI.UI.Controls.LinkClickedEventArgs e)
        {
