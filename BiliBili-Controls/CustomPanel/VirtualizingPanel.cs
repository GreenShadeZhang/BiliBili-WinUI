...
namespace BiliBili_Controls.CustomPanel
{
    public class VirtualizingPanel : Panel
    {
        ...
        public static readonly DependencyProperty OrientationProperty =
                DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(VirtualizingPanel), new PropertyMetadata(Microsoft.UI.Xaml.Controls.Orientation.Vertical, OnOrientationChanged));
        ...
        private void ItemContainerGeneratorItemsChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.ItemsChangedEventArgs e)
        {
            int index = -1;
